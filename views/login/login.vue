<template>
  <div class="page">
    <Form
      ...
      <FormItem prop="username"><Input
        v-model="loginForm.username"
        type="text"
        placeholder="用户名"
        autocomplete="off"
        prefix="ios-contact" /></FormItem>
    ...
    <h4
      style="text-align: center;color: #0081ff;margin-top: 30px;"
      @click="mouxan()">Powered By Mouxan</h4>
  </div>
</template>
<script>
import Checker from '@/utils/checker.js'
import { mapActions } from 'vuex'
import { validateUser, validatePass } from '@/utils/checker'
export default {
  data () {
    return {
      loginForm: {
